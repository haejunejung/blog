...
type ButtonProps = PropsWithChildren &
	...
	Omit<ComponentPropsWithoutRef<"button">, "variant">;

type ButtonRef = ComponentPropsWithRef<"button">["ref"];

function ButtonFn(props: ButtonProps, ref?: ButtonRef) {
...
export interface _internal_ComponentButton extends HasDisplayName {
	(props: ButtonProps & { ref?: ButtonRef }): ReturnType<typeof ButtonFn>;
}
